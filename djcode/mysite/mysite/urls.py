...
urlpatterns = patterns('',
    ...
    #url(r'^yijian/(?P<url>[\.\w-]+)/$', 'kucuntest.views.yijian'),
    url(r'^yijian/addyijian/url=(?P<url>.*)$', 'kucuntest.views.YijianCreate'),
    url(r'^yijian/edityijian/(\d{1,3})/$', 'kucuntest.views.edityijian'),
    url(r'^yijian/yijianlist/$', yijianlist.as_view()),
    url(r'^liuchengtu/$', 'kucuntest.views.liuchengtu'),
    url(r'^hello/$', hello),
